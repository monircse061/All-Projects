...
public class DiedVIP extends AppCompatActivity {
    ...
    String weburl = "https://defencecorona.online/swaranis-who-lost-their-lives-in-corona/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_died_v_i_p);
        Rel = findViewById(R.id.Rel);




        Toast.makeText(DiedVIP.this, "অপেক্ষা করুন", Toast.LENGTH_SHORT).show();
