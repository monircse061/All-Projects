...
public class SymandPrevention extends AppCompatActivity {
    ...
    String weburl = "https://defencecorona.online/symptoms-and-prevention/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_symand_prevention);
        Rel = findViewById(R.id.Rel);




        Toast.makeText(SymandPrevention.this, "অপেক্ষা করুন", Toast.LENGTH_SHORT).show();
