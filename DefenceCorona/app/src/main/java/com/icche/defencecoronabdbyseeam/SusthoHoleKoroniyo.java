...
public class SusthoHoleKoroniyo extends AppCompatActivity {
    ...
    String weburl = "https://defencecorona.online/what-to-do-after-recovering-from-kovid-19/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sustho_hole_koroniyo);
        Rel = findViewById(R.id.Rel);




        Toast.makeText(SusthoHoleKoroniyo.this, "অপেক্ষা করুন", Toast.LENGTH_SHORT).show();
