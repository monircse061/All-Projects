...
public class DiedDoctors extends AppCompatActivity {
    ...
    String weburl = "https://defencecorona.online/physician-who-dedicates-himself-to-medical-services/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_died_doctors);
        Rel = findViewById(R.id.Rel);




        Toast.makeText(DiedDoctors.this, "অপেক্ষা করুন", Toast.LENGTH_SHORT).show();
