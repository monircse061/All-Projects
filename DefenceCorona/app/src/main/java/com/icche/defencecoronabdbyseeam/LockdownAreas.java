...
public class LockdownAreas extends AppCompatActivity {
    ...
    String weburl = "https://defencecorona.online/lockdownareas/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lockdown_areas);
        Rel = findViewById(R.id.Rel);




        Toast.makeText(LockdownAreas.this, "অপেক্ষা করুন", Toast.LENGTH_SHORT).show();
