...
public class Gujob extends AppCompatActivity {
    ...
    String weburl = "https://defencecorona.online/category/rumors/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gujob);
        Rel = findViewById(R.id.Rel);




        Toast.makeText(Gujob.this, "অপেক্ষা করুন", Toast.LENGTH_SHORT).show();
