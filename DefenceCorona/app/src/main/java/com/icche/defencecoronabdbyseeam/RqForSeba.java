...
public class RqForSeba extends AppCompatActivity {
    ...
    String weburl = "https://defencecorona.online/request-for-service/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rq_for_seba);
        Rel = findViewById(R.id.Rel);




        Toast.makeText(RqForSeba.this, "অপেক্ষা করুন", Toast.LENGTH_SHORT).show();
