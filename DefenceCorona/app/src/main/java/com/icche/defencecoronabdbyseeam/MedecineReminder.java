...
public class MedecineReminder extends AppCompatActivity {
    ...
    String weburl = "https://defencecorona.online/medecine-reminder/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medecine_reminder);
        Rel = findViewById(R.id.Rel);




        Toast.makeText(MedecineReminder.this, "অপেক্ষা করুন", Toast.LENGTH_SHORT).show();
