...
public class LockdownTricks extends AppCompatActivity {
    ...
    String weburl = "https://defencecorona.online/category/things-to-do-in-lockdown/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lockdown_tricks);
        Rel = findViewById(R.id.Rel);




        Toast.makeText(LockdownTricks.this, "অপেক্ষা করুন", Toast.LENGTH_SHORT).show();
