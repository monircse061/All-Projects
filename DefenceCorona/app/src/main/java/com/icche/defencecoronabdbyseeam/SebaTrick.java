...
public class SebaTrick extends AppCompatActivity {
    ...
    String weburl = "https://defencecorona.online/method-of-serving-a-patient-infected-with-covid-19/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seba_trick);
        Rel = findViewById(R.id.Rel);




        Toast.makeText(SebaTrick.this, "অপেক্ষা করুন", Toast.LENGTH_SHORT).show();
