...
public class CovidFightersStory extends AppCompatActivity {
    ...
    String weburl = "https://defencecorona.online/category/the-story-of-the-corona-warriors/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_covid_fighters_story);
        Rel = findViewById(R.id.Rel);
        Toast.makeText(CovidFightersStory.this, "অপেক্ষা করুন", Toast.LENGTH_SHORT).show();
